...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/ctanner/CS3505/SpringProject1/ffmpeg --disable-yasm
...
CC_IDENT=gcc 4.4.6 (GCC) 20110731 (Red Hat 4.4.6-3)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
EXTRALIBS=-ldl -lasound -lSDL -lpthread -lm -pthread -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavfilter_VERSION=3.38.103
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=38
libavformat_VERSION=54.63.100
